...
select '600603', 6, '日志服务', '编辑规则', null, '00000000-0000-0000-0000-000000000000' union all


insert SYS_Logs_Rules (Code, Level, Source, Action, Message, CreatorUserId, ToDataBase)
select '608001', 6, '商城管理后台', '取消订单', null, '00000000-0000-0000-0000-000000000000', 1 union all
select '608002', 6, '商城管理后台', '确认订单', null, '00000000-0000-0000-0000-000000000000', 1 union all
select '608003', 6, '商城管理后台', '已发货', null, '00000000-0000-0000-0000-000000000000', 1 union all
select '608004', 6, '商城管理后台', '已制单', null, '00000000-0000-0000-0000-000000000000', 1 union all
select '608005', 6, '商城管理后台', '取消退货申请', null, '00000000-0000-0000-0000-000000000000', 1 union all
select '608006', 6, '商城管理后台', '确认退货申请', null, '00000000-0000-0000-0000-000000000000', 1 union all
select '608007', 6, '商城管理后台', '退货申请中已收货', null, '00000000-0000-0000-0000-000000000000', 1 union all
select '608008', 6, '商城管理后台', '退货申请中已完成', null, '00000000-0000-0000-0000-000000000000', 1